...
public class PageCharacteristicsServiceImpl implements PageCharacteristicsService {
	...
	public void addPageCharacteristics(PageCharacteristics page) throws PageCharacteristicsExistsException {
		PageCharacteristics pageCharacteristics = pageCharacteristicsDao
				.findPageCharacteristicsByUriAddress(page.getUriAddress());
	...
	public PageCharacteristics updatePageCharacteristics(PageCharacteristics page)
			throws PageCharacteristicsNotExistsException {
		PageCharacteristics pageCharacteristics = pageCharacteristicsDao
				.findPageCharacteristicsByUriAddress(page.getUriAddress());
	...
	@Override
	public PageCharacteristics getPageCharacteristicsByUriAddress(String urlAddress)
			throws PageCharacteristicsNotExistsException {
		PageCharacteristics pageCharacteristics = pageCharacteristicsDao
				.findPageCharacteristicsByUriAddress(urlAddress);
