package pl.zaprogramuj.dao.impl;
...
import pl.zaprogramuj.dao.AbstractDao;
import pl.zaprogramuj.dao.UserRoleDao;
import pl.zaprogramuj.domain.user.UserRole;
import pl.zaprogramuj.domain.user.UserRoleEnum;
