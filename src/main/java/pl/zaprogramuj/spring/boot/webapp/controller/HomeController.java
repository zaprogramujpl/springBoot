...
public class HomeController extends AbstractController {
	...
	public ModelAndView indexView(@RequestParam(value = "edit", required = false) String postEditView) {
		...
		mnv = getLoggedUserInformationComponent().userHasRole("ROLE_" + UserRoleEnum.ADMIN.toString())
				&& Boolean.TRUE.toString().equals(postEditView) ? new ModelAndView(SystemViewsName.EDIT_INDEX)
	...
	public ModelAndView registerUserPOST(@ModelAttribute("userProfileForm") @Validated UserProfileForm userProfileForm,
